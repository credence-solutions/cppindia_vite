    ...
    <div class="container">
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <article
          ...
          :style="`background: var(--card-bg); border: 1px solid ${proj.featured ? 'rgba(8,145,178,0.45)' : 'var(--card-border)'};`"
          onmouseover="this.style.borderColor='rgba(8,145,178,0.55)'; this.style.boxShadow='0 0 24px rgba(8,145,178,0.15)'; this.style.transform='translateY(-3px)'"
          ...
          <div class="flex items-start justify-between gap-2">
            <div>
              <div class="flex items-center gap-2 mb-1">
                ...
                <span v-if="proj.featured" class="text-[9px] font-bold uppercase px-1.5 py-[1px] rounded" style="background:rgba(8,145,178,0.2); color:var(--color-primary-soft);">Featured</span>
              </div>
