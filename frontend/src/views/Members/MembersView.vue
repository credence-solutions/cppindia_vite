<template>
  ...
  <section class="section--sm" style="background: var(--emphasis-bg);">
    <div class="container">
      ...
      <!-- Grid -->
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-3 xl:grid-cols-4">
        <article
        ...
        >
          ...
          <div v-if="member.talks > 0" class="flex flex-col gap-1.5">
            <a
              ...
              @click.stop
            >
              <svg width="8" height="8" viewBox="0 0 24 24" fill="var(--color-youtube)" class="flex-shrink-0"><polygon points="5 3 19 12 5 21 5 3"/></svg>
