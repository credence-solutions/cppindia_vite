<template>
  ...
  <section class="section" style="background: #07091C;">
    <div class="container">
        ...
        >
          ...
          <div class="flex flex-col flex-1 gap-3 p-5">
            <div class="flex items-center justify-between gap-2 flex-wrap">
              <time class="font-mono text-xs" style="color:rgba(148,163,184,0.5);" :datetime="post.date">{{ formatDate(post.date) }}</time>
            ...
            <h3 class="font-display font-bold text-base leading-snug flex-1" style="color:#E2E8F5;">{{ post.title }}</h3>
            <p class="text-sm" style="color:rgba(148,163,184,0.7);">{{ post.excerpt }}</p>
            <div class="flex items-center justify-between mt-auto pt-2">
              <div class="text-xs" style="color:rgba(148,163,184,0.5);">
      ...
      <!-- Write CTA -->
      <div class="mt-14 rounded-2xl p-8 text-center" style="background: linear-gradient(135deg, rgba(99,102,241,0.1), rgba(52,211,153,0.05)); border:1px solid rgba(99,102,241,0.25);">
        <p class="font-display font-bold text-lg mb-2" style="color:#E2E8F5;">Want to write for CppIndia?</p>
        <p class="text-sm mb-5" style="color:rgba(148,163,184,0.65);">Share a tutorial, trip report, or C++ insight with 1,000+ readers. We welcome all levels.</p>
...
const gradients = [
  'linear-gradient(135deg, rgba(99,102,241,0.25) 0%, rgba(34,211,238,0.15) 100%)',
  ...
  'linear-gradient(135deg, rgba(52,211,153,0.2) 0%, rgba(99,102,241,0.12) 100%)',
  'linear-gradient(135deg, rgba(167,139,250,0.2) 0%, rgba(34,211,238,0.12) 100%)',
]
