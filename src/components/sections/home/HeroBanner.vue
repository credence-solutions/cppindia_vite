        ...
        <div>
          ...
          <div class="gsap-reveal flex flex-wrap items-center gap-3 mb-10">
            <a :href="SITE.discordInvite"
              ...
              style="background:linear-gradient(135deg,#5865F2,#7289DA);box-shadow:0 4px 20px rgba(88,101,242,0.45);"
